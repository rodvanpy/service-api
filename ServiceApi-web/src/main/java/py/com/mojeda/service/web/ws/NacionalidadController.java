...
public class NacionalidadController extends BaseController {
    ...
    ResponseListDTO listar(@ModelAttribute("_search") boolean filtrar,
        ...
        Nacionalidades model = new Nacionalidades();
        
        List<Map<String, Object>> listMapGrupos = null;
        try {
            inicializarNacionalidadesManager();
            ...
            if (!todos) {
                total = Long.parseLong(nacionalidadesManager.list(model).size() + "");
            }
            ...
            listMapGrupos = nacionalidadesManager.listAtributos(model, atributos.split(","), todos, inicio, cantidad,
    ...
    ResponseDTO getObject(
        ...
        try {
            ...
            Nacionalidades model = nacionalidadesManager.get(id);
    ...
    public @ResponseBody
    ResponseDTO create(
            @RequestBody @Valid Nacionalidades model,
            Errors errors) {
        ...
        try {
            ...
            nacionalidadesManager.save(model);

            response.setStatus(200);
            response.setMessage("La nacionalidad ha sido guardada");
            response.setModel(nacionalidadesManager.get(model));
    ...
    ResponseDTO update(
        ...
        try {
            ...
            Nacionalidades dato = nacionalidadesManager.get(id);
            ...
            nacionalidadesManager.update(model);
