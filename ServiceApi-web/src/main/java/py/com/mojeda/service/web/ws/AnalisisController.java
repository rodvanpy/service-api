...
public class AnalisisController extends BaseController{
    ...
    String atributos = "id,fechaInicioAnalisis,fechaFinAnalisis,fechaPrimeraAprobRech,fechaSegundaAprobRech,funcionarioAprobacion.id,estado.id,tipoDestino.id,descripcionDestino,"
            + "tipoGarantia.id,montoSolicitado,montoCuota,montoAprobado,funcionarioAnalisis.id,funcionarioVerificador.id,obsApro,propuestaSolicitud.id,activo";
