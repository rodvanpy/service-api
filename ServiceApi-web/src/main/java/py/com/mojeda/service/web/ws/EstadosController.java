...
public class EstadosController extends BaseController {

    String atributos = "id,nombre,descripcion,codigo,activo";
    ...
    ResponseListDTO listar(@ModelAttribute("_search") boolean filtrar,
        ...
        EstadosSolicitud model = new EstadosSolicitud();
        model.setActivo("S");
        ...
        try {
            ...
            if (!todos) {
                total = Long.parseLong(estadosSolicitudManager.list(model).size() + "");
            }
            ...
            listMapGrupos = estadosSolicitudManager.listAtributos(model, atributos.split(","), todos, inicio, cantidad,
    ...
    ResponseDTO getObject(
        ...
        try {
            ...
            EstadosSolicitud model = estadosSolicitudManager.get(id);
    ...
    public @ResponseBody
    ResponseDTO create(
            @RequestBody @Valid EstadosSolicitud model,
            Errors errors) {
        ...
        try {
            ...
            EstadosSolicitud dato = new EstadosSolicitud();
            dato.setNombre(model.getNombre());
            
            Map<String,Object> objMaps = estadosSolicitudManager.getLike(dato,"id".split(","));
            ...
            //Numero Sucursal
            Integer numeroCodigo = estadosSolicitudManager.total(new EstadosSolicitud()) + 1;
            ...
            estadosSolicitudManager.save(model);

            EstadosSolicitud empresa = new EstadosSolicitud();
            empresa.setCodigo(model.getCodigo());

            response.setStatus(200);
            response.setMessage("El registro ha sido guardado");
            response.setModel(estadosSolicitudManager.get(empresa));
    ...
    ResponseDTO update(
        ...
        try {
            ...
            EstadosSolicitud dato = estadosSolicitudManager.get(id);
            
            EstadosSolicitud object = new EstadosSolicitud();
            object.setNombre(model.getNombre());
            
            Map<String, Object> objectMaps = estadosSolicitudManager.getLike(object, "id".split(","));
            if (objectMaps != null
            ...
            estadosSolicitudManager.update(model);
