...
public class VehiculoController extends BaseController {
    ...
    String atributos = "id,numeroFinca,cuentaCatastral,distrito,escriturado,edificado,hipotecado,fechaHipoteca,vencimientoHipoteca,lugarHipoteca"
            + ",fechaDeclaracion,cuotaMensual,valorActual,saldo,direccion,marca,modeloAnio,fechaVenta,numeroMatricula,activo";
...
//            model.setIdUsuarioModificacion(userDetail.getId());
    ...
    /**
     * Mapping para el metodo DELETE de la vista.(eliminar Bienes)
     *
     * @param id de la entidad
     * @return
     */
    ...
    ResponseDTO deleteObject(
        ...
        try {
            ...
            Bienes model = bienesManager.get(id);
            model.setActivo("N");
