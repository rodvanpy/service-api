 ...
 */
@Controller
@RequestMapping(value = "/egresos")
public class EgresosController extends BaseController {
    
    String atributos = "id,monto,tipoIngresosEgresos.id,activo";
    ...
    ResponseListDTO listar(@ModelAttribute("fkModel") Long id,
        ...
        IngresosEgresos model = new IngresosEgresos();
        model.setActivo("S");
        model.setTipoIngresosEgresos(new TipoIngresosEgresos("E"));
        ...
        try {
            ...
            if (!todos) {
                total = Long.parseLong(ingresosEgresosManager.list(model).size() + "");
            }
            ...
            listMapGrupos = ingresosEgresosManager.listAtributos(model, atributos.split(","), todos, inicio, cantidad,
                    ordenarPor.split(","), sentidoOrdenamiento.split(","), true, true, camposFiltros, valorFiltro,
                    null, null, null, null, null, null, null, null, true);
            
            for(Map<String, Object> rpc: listMapGrupos){
                rpc.put("tipoIngresosEgresos", tipoEgresosManager.getAtributos(new TipoIngresosEgresos(Long.parseLong(rpc.get("tipoIngresosEgresos.id").toString())), "id,nombre,codigo".split(",")));
            }
