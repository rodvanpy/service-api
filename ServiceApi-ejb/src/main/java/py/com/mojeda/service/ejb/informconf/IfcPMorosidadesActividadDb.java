...
public class IfcPMorosidadesActividadDb {
    ...
    public IfcPMorosidadesActividadDb() {
    }

    public IfcPMorosidadesActividadDb(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof IfcPMorosidadesActividadDb)) {
            return false;
        }
        IfcPMorosidadesActividadDb other = (IfcPMorosidadesActividadDb) object;
    ...
    public String toString() {
        return "javaapplication5.IfcPMorosidadesActividadDb[ id=" + id + " ]";
    }
